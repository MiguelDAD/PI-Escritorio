 ...
 * @author Miguel
 */
public class FiltrarDatosController implements Initializable {
    ...
    @FXML
    private MFXComboBox<String> estadoCombo;
    ...
    private void filtrarDatos(ActionEvent event) {        
        ...
        aplicacion.filtrarDatos(deporteCombo.getText(), estadoCombo.getText());

    }

    private void cargarCombos() {
        estadoCombo.getItems().add("Jugandose");
        estadoCombo.getItems().add("Esperando Jugadores");
        estadoCombo.getItems().add("Cancelado");
        estadoCombo.getItems().add("Finalizado");
