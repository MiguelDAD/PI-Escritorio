 ...
 * @author Miguel
 */
public class TorneoOchoController implements Initializable {
    ...
    @FXML
    private MFXLegacyListView<TorneoEnfrentamientos> enfrentamiento31;
    @FXML
    private MFXLegacyListView<TorneoEnfrentamientos> enfrentamiento22;
    @FXML
    private MFXLegacyListView<TorneoEnfrentamientos> enfrentamiento13;
    @FXML
    private MFXLegacyListView<TorneoEnfrentamientos> enfrentamiento14;
    @FXML
    ...
    public void insertarEquipos() {
        ...
        rondas1.add(enfrentamiento13);
        rondas1.add(enfrentamiento14);

        Queue<MFXLegacyListView<TorneoEnfrentamientos>> rondas2 = new LinkedList<>();
        rondas2.add(enfrentamiento21);
        rondas2.add(enfrentamiento22);

        Queue<MFXLegacyListView<TorneoEnfrentamientos>> rondas3 = new LinkedList<>();
        rondas3.add(enfrentamiento31);
                    ...
                    if (mensajeRespuesta[0].equals(Mensajes.TOURNAMENTS_ROUNDS_OK)) {
                        ...
                        for (int i = 0; i < rondas.length; i++) {
                            ...
                            for (int j = 0; j < equiposRonda.length; j++) {
                                ...
                                } else if (rondaEnfrentamiento.equalsIgnoreCase("3")) {
                                    MFXLegacyListView<TorneoEnfrentamientos> r3 = rondas3.poll();
                                    if (r3 != null) {
                                        r3.setCellFactory(param -> new TorneoRondasAdapter());
                                        TorneoEnfrentamientos te = new TorneoEnfrentamientos(Integer.parseInt(id), eLocal, ptosLocal,
                                                eVisitante, ptosVisitante, Integer.parseInt(rondaEnfrentamiento));
                                        te.setIdTorneo(torneoActual.getId());
                                        r3.getItems().add(te);
